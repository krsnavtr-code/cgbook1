      ...
      >
        <AnimatePresence mode="popLayout">
          {previewUrls.length > 0 ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 max-h-64 overflow-y-auto p-2">
                {previewUrls.map((url, index) => (
                  <motion.div
                    ...
                    className="relative group bg-black/5 rounded-lg overflow-hidden aspect-square"
                  >
                    <img
                      src={url}
                      alt={`Preview ${index}`}
            ...
            >
              <div className="w-16 h-16 mb-4 rounded-full bg-blue-50 flex items-center justify-center text-blue-500 group-hover:scale-110 transition-transform duration-300">
