...
const SupportCenter = () => {
  ...
  // Get WhatsApp number from owner info
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors duration-300">
      ...
      <header className="px-6 py-12 text-center max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-4">
          How can we{" "}
          <span className="text-pink-500 underline decoration-pink-500/30">
            help?
          </span>
        </h1>
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="p-8 bg-gradient-to-br from-pink-500 to-rose-600 rounded-[2rem] text-white shadow-xl shadow-pink-500/20">
            ...
            <p className="text-pink-100 text-sm leading-relaxed">
              Your security is our priority. Our support agents will never ask
              for your login password or payment OTPs.
            </p>
          </div>
        </div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDownIcon
                    className={`h-5 w-5 text-zinc-400 transition-transform duration-300 ${openFaq === index ? "rotate-180" : ""}`}
                  />
                </button>
                <div
